...
## About policy 
This project hasn't any commercial purpose, it was done only to practice my knowledge that I acquired in the past and show it to the world, the use of celebrities pictures is only to make funnier this program with these examples. 

## How start the project 
After all this theoretical plan, the requirements that you need to use this project are: 
> ⚠️ **IMPORTANT**: This project strictly use Python 3.10 to libraries compability 
1. Install these packages if you didn't before: `pip install opencv-python face-recognition numpy`
2. Create a production environment: `py -3.10 -m venv venv >> .\venv\Scripts\activate`
3. Let's start the program: `py .\main.py`
